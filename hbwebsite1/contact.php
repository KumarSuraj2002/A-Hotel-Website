...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        ...
        <p class="text-center mt-3">
            ...
            Nostrum quaerat vitae inventore <br> dolorum ad et, officia
            provident soluta sit repellat?
        </p>
    </div>
            ...
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                ...
                <div class="bg-white rounded shadow p-4 ">
                    <iframe class="w-100 rounded mb-4" height="320px"
                        ...
                        loading="lazy"></iframe>
                    <h5>Address</h5>
                    <a href="https://maps.app.goo.gl/9WCfHBj1YJ28EUds5" target="_blank" class="d-inline-block text-decoration-none text-dark mb-2">
                        <i class="bi bi-geo-alt-fill"></i> ABC, Bokaro Steel City, Jharkhand
                    </a>
                    ...
                    <a href="mailto: surajkumarhero6202@gmail.com" class="d-inline-block text-decoration-none text-dark">
                        <i class="bi bi-envelope-fill"></i> surajkumarhero6202@gmail.com
                    </a>
